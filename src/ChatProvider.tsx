...
import { useDebounceTyping } from "@chatscope/use-chat/dist/provider/useDebounceTyping";
import { useThrottledSendTyping } from "@chatscope/use-chat/dist/provider/useThrottledSendTyping";
import {
  ChatMessage,
  ChatState,
  Conversation,
...
import { IStorage } from "./ChatStorage";
...
export const ChatProvider = <S extends IChatService>({
  ...
  const addMessage = useCallback(
    (
      ...
      storage.addMessage(message, conversationId, generateId, addToTop);
      updateState();
    },
    [storage, updateState]
  );
